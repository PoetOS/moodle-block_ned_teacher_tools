...
class coursecategory_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform = $this->_form;
        $mform->addElement('header', '', get_string('markinmanagerscoursecats', 'block_ned_teacher_tools'), '');
        $mform->addElement('static', 'description', '', get_string('markinmanagerscoursecatsdesc', 'block_ned_teacher_tools'));
        ...
        $categories = block_ned_teacher_tools_get_course_category_tree();

        $c1->text = block_ned_teacher_tools_category_tree_form($categories,
