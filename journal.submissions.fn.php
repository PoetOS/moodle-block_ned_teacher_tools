...
if (($show == 'unmarked') || ($show == 'saved') || ($expand)) {
    if ($gradingonly) {
        ...
        $o .= '<form action="' . $CFG->wwwroot . '/blocks/ned_teacher_tools/fn_gradebook.php" method="post" class="gradeform mform" autocomplete="off">';
        ...
        if ($user = $DB->get_record('user', array('id' => $userid))) {
            ...
            if (count($attempts) > 1) {
                ...
                $o .= get_string('gradingstudentprogress', 'block_ned_teacher_tools',
            ...
            if ($entry) {
                ...
                $o .= '<b>'.get_string('teachersfeedback', 'block_ned_teacher_tools').'</b><br /><span class="teacher_feedback_info">'.
            ...
            if ($entry) {
                $o .= " <div class=\"lastedit\"><strong>" . get_string('studentssubmission', 'block_ned_teacher_tools') . ": </strong>" . userdate($entry->modified) . "</div>";
            }
    ...
    $o .= block_ned_teacher_tools_view_journal_submissions($journal, $students, $cm, $course, $pageparams, $show);
