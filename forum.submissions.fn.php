...
if (($show == 'unmarked') || ($show == 'marked')) {
    if ($stposts) {
                      ...
                      <tr>
                              ...
                              <table width="100%" border="0">
                                <tr>
                                  <td valign="top" nowrap style="text-align: right">'.
                                        get_string('forum', 'block_ned_teacher_tools').': </td>
                                  <td valign="top" class="forum-header-data">'.$forum->name.'</td>
                                </tr>
                                <tr>
                                  <td valign="top" nowrap style="text-align: right">'.
                                        get_string('type', 'block_ned_teacher_tools').': </td>
                        ...
                        <td valign="middle" width="50%">
                              <table width="100%" border="0">
                                <tr>
                                  <td valign="top" nowrap style="text-align: right">'.
                                        get_string('scale', 'block_ned_teacher_tools').': </td>
                                  <td valign="top" class="forum-header-data">/'.$forum->scale.'</td>
                                </tr>
                                <tr>
                                  <td valign="top" nowrap style="text-align: right">'.
                                        get_string('whocanrate', 'block_ned_teacher_tools').': </td>
                                  <td valign="top" class="forum-header-data">'.$rolenamestring.'</td>
                                </tr>
                                <tr>
                                  <td valign="top" nowrap style="text-align: right">'.
                                        get_string('aggregatetype', 'block_ned_teacher_tools').': </td>
        ...
        $o .= '<div style="float: left;">'.get_string('student_have_posted', 'block_ned_teacher_tools').'</div>';
        ...
        $o .= "<tr>";
        $o .= "<th colspan='2' class='fn-student'>".get_string('student', 'block_ned_teacher_tools')." </th>
              <th class='fn-posts'>".get_string('posts', 'block_ned_teacher_tools')."</th>
              <th class='fn-replies'>".get_string('replies', 'block_ned_teacher_tools')."</th>
              <th class='fn-rating'>".get_string('rating', 'block_ned_teacher_tools')."</th>";
        $o .= "</tr>";
...
$jsmodule1 = array(
    ...
    'fullpath' => '/blocks/ned_teacher_tools/module1.js',
