...
if (($show == 'marked') || ($show == 'unmarked')) {
    ...
    $headers = array(
        'userpicture' => '',
        'name' => get_string('student', 'block_ned_teacher_tools'),
    ...
    foreach ($columns as $column) {
        ...
        if (($column == 'userpicture') || ($column == 'edit')) {
            ...
            $sortingurl = new moodle_url('/blocks/ned_teacher_tools/fn_gradebook.php?', $qsortingparams);
    ...
    $targetonurl = new moodle_url('/blocks/ned_teacher_tools/fn_gradebook.php?', $targetonparams);
    $targetoffurl = new moodle_url('/blocks/ned_teacher_tools/fn_gradebook.php?', $targetoffparams);
    ...
    $o .= '&nbsp;&nbsp;&nbsp;<a href="' . $CFG->wwwroot . '/mod/quiz/report.php?id=' . $cm->id .
        ...
        get_string('manualgrading', 'block_ned_teacher_tools').'</a>';
    ...
    $pagingurl = new moodle_url('/blocks/ned_teacher_tools/fn_gradebook.php?', $qpagingparams);
