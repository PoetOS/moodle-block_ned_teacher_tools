...
$PAGE->set_url(
    new moodle_url('/blocks/ned_teacher_tools/fn_gradebook.php',
...
$modgradedisparray = block_ned_teacher_tools_supported_mods();
                ...
                if (file_exists($libfile)) {
                    ...
                    if ((($mod->modname != 'forum') || (($instance->assessed > 0) && has_capability('mod/forum:rate', $mcontext)))
                        ...
                        if (!empty($modgrades)) {
                            ...
                            $modurl = new moodle_url('/blocks/ned_teacher_tools/fn_gradebook.php', array(
                                'courseid' => $course->id,
                                'show' => $show,
                                'sort' => $sort,
                                'view' => $view,
...
block_ned_teacher_tools_groups_print_course_menu($course, $groupurl->out(), false, $group);
echo "&nbsp;&nbsp;";
echo $participantsform . "&nbsp;&nbsp;";
echo $viewform . " ";

echo html_writer::link('#',
    html_writer::img($OUTPUT->image_url('fullscreen', 'block_ned_teacher_tools'), ''),
...
echo '</td>
        ...
        <tr>
        <td colspan="2">
            '.block_ned_teacher_tools_footer().'
        <td>
        </tr>
    </table>
</div>';
