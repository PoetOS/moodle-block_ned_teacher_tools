...
$filterform = '<div class="ned-teacher_tools-menu-wrapper">';
$filterform .= block_ned_teacher_tools_groups_print_course_menu(
    $course, $CFG->wwwroot . '/blocks/ned_teacher_tools/progress_report.php?id=' .
    $course->id . '&unsubmitted=' . $unsubmitted . '&showsuspendedusers=' . $showsuspendedusers, true, $group);
...
$filterform .= '<div class="groupselector">' . $OUTPUT->render($select) . '</div>';
...
$filterform .= "<div class=\"groupselector\"><img src=\"" . $OUTPUT->image_url('i/grades') . "\" class=\"icon\" alt=\"\" />" .
...
if ($students) {
    ...
    $toggleicon = html_writer::img($OUTPUT->image_url('hightlightoff', 'block_ned_teacher_tools'), '', array('class' => 'row-toggle icon'));
