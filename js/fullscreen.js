...
$(document).ready(function() {
    $('#page-blocks-ned_teacher_tools-fn_gradebook .visibleifjs a.btn').html('Annotate PDF');
    ...
    var onZoom = function () {
        ...
        if (zoomin) {
            ...
            M.util.set_user_preference('block_ned_teacher_tools_zoom', 'nozoom');
        } else {
            $('body').addClass('zoomin');
            M.util.set_user_preference('block_ned_teacher_tools_zoom', 'zoomin');
        }
    };
    ...
    $(".ned-change-html-editor").click(function() {
        ...
        if (datastatus == 'showonlineeditor') {
            M.util.set_user_preference('block_ned_teacher_tools_onlineeditor', 'show');
            alert('HTML editor was enabled.');
        } else {
            M.util.set_user_preference('block_ned_teacher_tools_onlineeditor', 'hide');
    ...
    $("#ned-override-remover").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: M.cfg.wwwroot +"/blocks/ned_teacher_tools/grade_override.php",
            data: {
                'mod': mod,
                'action': action,
                'instance': instance,
